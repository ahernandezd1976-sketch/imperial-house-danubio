...
const familyMembersFR: FamilyMember[] = [
  ...
  },
  {
    ...
    style: "Son Altesse Impériale",
    position: "far left",
    bio: "Maréchal de la Couronne et l'un des officiers les plus éminents de la Maison Impériale. Reiner de Habsbourg est responsable de l'organisation de toutes les cérémonies impériales, des visites d'État et du protocole de la cour. Diplômé de l'Académie Militaire Impériale, il détient le grade de Général dans la Garde Impériale et a servi dans des missions diplomatiques en Europe centrale et dans les Balkans. Il est considéré comme la force organisatrice indispensable derrière la vie cérémonielle de la Cour Impériale.",
    initials: "RV",
...
const familyMembersCS: FamilyMember[] = [
  ...
  },
  {
    ...
    style: "Jeho Císařská Výsost",
    position: "far left",
    bio: "Maršál koruny a jeden z nejvyšších důstojníků Císařské domácnosti. Reiner von Habsburg je zodpovědný za organizaci všech císařských ceremonií, státních návštěv a dvorského protokolu. Absolvent Císařské vojenské akademie, zastává hodnost generála v Císařské gardě a sloužil na diplomatických misích ve střední Evropě a na Balkáně. Je považován za nepostradatelnou organizační sílu ceremoniálního života Císařského dvora.",
    initials: "RV",
...
const familyMembersHR: FamilyMember[] = [
  ...
  },
  {
    ...
    style: "Njegovo Carsko Visočanstvo",
    position: "far left",
    bio: "Maršal krune i jedan od najstarijih časnika Carskog kućanstva. Reiner von Habsburg odgovoran je za organizaciju svih carskih ceremonija, državnih posjeta i dvorskog protokola. Diplomant Carske vojne akademije, nosi čin generala u Carskoj gardi i služio je na diplomatskim misijama u srednjoj Europi i na Balkanu. Smatra se nezamjenjivom organizacijskom snagom iza ceremonijalnog života Carskog dvora.",
    initials: "RV",
